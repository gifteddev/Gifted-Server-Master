...
const reactAppPackagePath = path.join(__dirname, "client", "package.json");
...
const buildPackage = Object.assign({ homepage: `/${stage}/shopify` }, package);
...
try {
  // Run the app build
  console.log(
    `Building for ${stage === "." ? "localhost" : ` STAGE "${stage}"`}...`
  );
